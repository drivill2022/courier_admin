...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'hub' => \App\Http\Middleware\RedirectIfNotHub::class,
        ...
        'hub.guest' => \App\Http\Middleware\RedirectIfHub::class,
        'seller.guest' => \App\Http\Middleware\RedirectIfSeller::class,

        'roleAuth' => \App\Http\Middleware\RolesAuth::class,
        'passport.rider' => \App\Http\Middleware\RiderPassportAuthSet::class,
