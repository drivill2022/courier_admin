...
class HelpController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.help.create',compact('shipment_list','marchants','title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            $help = $request->all();  
            $help['created_by'] = Auth::guard('admin')->user()->id;       
            Help::create($help);           
            return redirect()->route('admin.help.index')->with('flash_success','Complain Added Successfully');
            }
        catch (Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            {
                $help->updated_by = Auth::guard('admin')->user()->id;         
            }   
            $help->save();
    ...
    public function report_claim($shipment_id)
    {
        ...
        $title = "Report Claim";
        return view('admin.help.create',compact('shipment','title'));
    }
}
