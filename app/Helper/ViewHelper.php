...
function shipment_status($status)
{
    switch ($status) {
        ...
        //return 'Cancelled(delivery attempt failed)';
...
function getMerchant($merchant_id)
{
  ...
  function notificationList($merchant_id)
    ...
    function cancelReason($shipment_id)
    {
      $shipment = App\models\ShipmentStatusLog::where('shipment_id',$shipment_id)->orderBy('id','desc')->first();
