        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Edit Role</h4> <a href="{{ route('admin.roles.index') }}" class="btn btn-primary pull-right"><i class="fa fa-angle-left"></i> Back</a>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <div class="p-4 border-top">
                           <form class="form-horizontal" action="{{route('admin.roles.update', $role->id )}}" method="POST" enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10">
                                    <input class="form-control" type="text" value="{{ $role->name }}" name="name" required id="name" placeholder="Role Name">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10">
                                    <input class="form-control" type="text" value="{{ $role->description }}" name="description" required id="description" placeholder="Role Description">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-10">
                                    <select class="form-control" name="permissions[]" id="permissions" multiple placeholder="Select Permissions">
                                        ...
                                        <option value="{{$permission->id}}" @if(in_array($permission->id, $role->permission_ids)) selected @endif >{{ucwords($permission->name)}}</option> 
                                        @endforeach                           
                                    </select>
                                </div>
                            </div>          
