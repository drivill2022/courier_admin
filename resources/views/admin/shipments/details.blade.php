...
<div class="product-desc">
    <div class=row>
<div class="col-md-6"><h5 class="pb-3 nav-tabs-custom">Shipment Number: {{$shipment->shipment_no}}</h5></div>
<!-- <div class="col-md-6 text-right"><a class="btn btn-info" href="{{route('admin.edit-info',$shipment->id)}}">Update Info
</a></div> -->
</div>
...
<table class="table table-nowrap mb-0">
    <tbody>
        ...
        <tr>
            <th scope="row" style="width: 20%;">Rider</th>
            <td>
                {{@$shipment->rider->rider->name}}
            </td>
        </tr> 
        <tr>
        ...
        @if($shipment->status == 8 || $shipment->status == 10 || $shipment->status == 12)
             <tr>
                <th scope="row">Reason</th>
                <td>{{@cancelReason($shipment->id)}}</td>
            </tr>
