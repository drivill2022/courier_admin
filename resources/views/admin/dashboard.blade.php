        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <div class="row">
                    <div class="col-6">
                      <h4 class="mb-0">Hi, Welcome</h4>  <p>Dashboard</p>
                    </div>
                    <div class="col-6">
                      <a href="{{route('admin.shipments.create')}}" class="btn btn-primary pull-right">Add Shipment</a>
                   </div>
                   </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <ul class="my-3 nav nav-pills nav-justified bg-light" role="tablist">
                      <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($type == 'daily') active @endif" href="{{ route('admin.dashboard') }}" 
                            role="tab">
                            <span class="d-none d-sm-block">Daily</span>
                        </a>
                      </li>
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($type == 'weekly') active @endif" href="{{ route('admin.dashboard','type=weekly') }}" 
                            role="tab">
                            <span class="d-none d-sm-block">Weekly</span>
                        </a>
                      </li>
                       <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($type == 'yearly') active @endif" href="{{ route('admin.dashboard','type=yearly') }}" 
                            role="tab">
                            <span class="d-none d-sm-block">Yearly</span>
                        </a>
                      </li>
                  </ul>
                   <form action="{{ route('admin.dashboard')}}?type={{$type}}" method="POST">@csrf
                    ...
                    <div class="mt-1">
                        <ul class="list-inline main-chart mb-0">
                            <li class="list-inline-item chart-border-left me-0 border-0">
                                <h3 class="text-primary">{{config('constants.currency')}}<span class="total_earnings">0</span><span class="text-muted d-inline-block font-size-15 ms-3">Total COD Collected</span></h3>
                            </li>
