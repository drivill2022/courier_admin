...
$current = route('admin.merchant_shipment_report',[$active]).'/';
@endphp
                <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Merchant Shipment Details</h4>
                    ...
                    <ul class="my-3 nav nav-pills nav-justified bg-light" role="tablist">
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'daily') active @endif" href="{{ route('admin.merchant_shipment_report',['daily']) }}@if($resp['merchant_id'])/{{$resp['merchant_id']}}@endif"
                                role="tab">
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'weekly') active @endif" href="{{ route('admin.merchant_shipment_report',['weekly']) }}@if($resp['merchant_id'])/{{$resp['merchant_id']}}@endif"
                                role="tab">
                                <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'monthly') active @endif" href="{{ route('admin.merchant_shipment_report',['monthly']) }}@if($resp['merchant_id'])/{{$resp['merchant_id']}}@endif" role="tab">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <form action="{{ route('admin.merchant_shipment_report',[$active]) }}@if($resp['merchant_id'])/{{$resp['merchant_id']}}@endif" method="POST">@csrf
