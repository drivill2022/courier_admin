...
$current = route('admin.merchant_earning_statement',[$active]).'/';
@endphp
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Merchant Earning statement</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                            <label class="form-label" for="manufacturername">Merchant :</label>
                                                ...
                                                @foreach($resp['merchants'] as $m)
                                                <option value="{{$m->id}}" @if ($resp['merchant_id']==$m->id)
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link @if($active == 'daily') active @endif" href="{{ route('admin.merchant_earning_statement',['daily']) }}@if($resp['merchant_id'])/{{$resp['merchant_id']}}@endif"
                                            role="tab">
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link @if($active == 'weekly') active @endif" href="{{ route('admin.merchant_earning_statement',['weekly']) }}@if($resp['merchant_id'])/{{$resp['merchant_id']}}@endif"
                                            role="tab">
                                            <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link @if($active == 'monthly') active @endif" href="{{ route('admin.merchant_earning_statement',['monthly']) }}@if($resp['merchant_id'])/{{$resp['merchant_id']}}@endif" role="tab">
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                        <div class="tab-pane active" id="navpills2-all" role="tabpanel">
                                         ...
                                         <div class="row">
                                            <div class="col-12">
                                                <form action="{{ route('admin.merchant_earning_statement',[$active]) }}@if($resp['merchant_id'])/{{$resp['merchant_id']}}@endif" method="POST">@csrf
