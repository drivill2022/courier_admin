...
@section('title', 'Add Merchant Banner')
    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
          <h4 class="mb-0">Add Merchant Banner</h4>
            ...
            <div class="card">
              <div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                <div class="p-4 border-top">
                  <form method="POST" action="{{ route('admin.merchant-banners.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                       <div class="col-md-12">
                            <div class="mb-3">
                      ...
                      <div class="row mb-4">
                        <div class="col text-end">
                          <a href="{{ route('admin.merchant-banners.index') }}" class="btn btn-danger"> <i class="uil uil-times me-1"></i> Cancel </a>
