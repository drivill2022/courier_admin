    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
          ...
          <a class="float-right" href="{{ route('admin.sellers.items.index',$seller->id) }}">
            ...
            <div class="card">
              ...
              <div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                <div class="p-4 border-top">
                  <form method="POST" action="{{ route('admin.sellers.items.store',$seller->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row my-4">
                      <div class="col text-end">
                        <a href="{{ route('admin.sellers.items.index',$seller->id) }}" class="btn btn-danger"> <i class="uil uil-times me-1"></i> Cancel </a>
