    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
          <h4 class="mb-0">Edit Product Type</h4>
            ...
            <div class="card">
              <div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                <div class="p-4 border-top">
                  <form method="POST" action="{{ route('admin.product-types.update', $type->id) }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="_method" value="PATCH">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                          <label class="form-label" for="name">Product Type  Name</label>
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <select  class="form-select" name="status" id="statusm">
                            <option value="Active" @if ($type->status=='Active')
                              selected @endif>Active</option>
                              <option value="Blocked" @if ($type->status=='Blocked')
                          ...
                          <div class="row my-4">
                            <div class="col text-end">
                              <a href="{{ route('admin.product-types.index') }}" class="btn btn-danger"> <i class="uil uil-times me-1"></i> Cancel </a>
