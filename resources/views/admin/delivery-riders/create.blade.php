                    ...
                    <div id="addproduct-accordion" class="custom-accordion">
                        <div class="card">
                            <div class="p-4 border-top">
                                <form method="POST" action="{{ route('admin.riders.store') }}" name="add-riders" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-6"> 
...
<div class="col-lg-6">
    ...
    <div class="mb-3">
        <label class="form-label" for="father_nid">Father NID number: </label>
