                                            ...
                                            <div class="p-4 border-top">
                                                <form>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="productname">Pickup Address</label>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="productname">Delivery Address:</label>
                                                                <textarea class="form-control" id="metadescription" rows="2"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="mb-3">
                                                                <label class="form-label" for="manufacturername">Product Weight</label>
                                                                <select  class="form-select">
                                                                  <option >0.5-1.0 kg</option>
                                                                  <option >1.0-1.5 kg</option>
                                                                  <option >1.5-2.0 kg</option>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="productname">Time</label>
                                                                <input id="productname" name="productname" type="text" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label class="form-label" for="productname">Delivery Cost</label>
                                                                <input id="productname" name="productname" type="text" class="form-control">
                                                            </div>
                                                        </div>
