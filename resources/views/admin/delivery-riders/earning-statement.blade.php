...
$current = route('admin.rider_earning_statement',[$active]).'/';
 @endphp
                ...
                <div class="card-body">
                    ...
                    <ul class="my-3 nav nav-pills nav-justified bg-light" role="tablist">
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'daily') active @endif" href="{{ route('admin.rider_earning_statement',['daily']) }}@if($resp['rider_id'])/{{$resp['rider_id']}}@endif"
                                role="tab">
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'weekly') active @endif" href="{{ route('admin.rider_earning_statement',['weekly']) }}@if($resp['rider_id'])/{{$resp['rider_id']}}@endif"
                                role="tab">
                                <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'monthly') active @endif" href="{{ route('admin.rider_earning_statement',['monthly']) }}@if($resp['rider_id'])/{{$resp['rider_id']}}@endif" role="tab">
                    ...
                    <div class="tab-content p-3 text-muted">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <form action="{{ route('admin.rider_earning_statement',[$active]) }}@if($resp['rider_id'])/{{$resp['rider_id']}}@endif" method="POST">@csrf
