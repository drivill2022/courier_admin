                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Delivery Charges List</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div>
                                    ...
                                    <a href="add-delivery-charges.html">
                                    <button type="button" class="btn btn-success waves-effect waves-light mb-3"><i class="mdi mdi-plus me-1"></i> Add Delivery Charges </button></a>
                                </div>
                                <div class="card">
                                                        ...
                                                        <table class="table table-centered datatable dt-responsive nowrap table-card-list" style="border-collapse: collapse; border-spacing: 0 12px; width: 100%;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>$10</td>
                                                                    <td class="d-flex">
                                                                        <a href="add-delivery-charges.html" class="px-3 text-primary"><i class="uil uil-pen font-size-18"></i></a>
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Crafted with <i class="mdi mdi-heart text-danger"></i> by <a href="" target="_blank" class="text-reset">Syscraft</a>
                                </div>
                            </div> -->
                        </div>
                    </div>
