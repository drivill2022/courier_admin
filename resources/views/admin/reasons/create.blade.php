                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <select  class="form-select" name="reason_for" id="reason_form">
                            <option value="0" @if (old('reason_for')=='0') selected @endif>All</option>
                            <option value="1" @if (old('reason_for')=='1') selected @endif>Admin</option>
                            <option value="2" @if (old('reason_for')=='2') selected @endif>Rider</option>
                            <option value="3" @if (old('reason_for')=='3') selected @endif>Hub</option>
                            <option value="4" @if (old('reason_for')=='4') selected @endif>Merchant</option>
                            <option value="5" @if (old('reason_for')=='5') selected @endif>Seller</option>
                            <option value="6" @if (old('reason_for')=='6') selected @endif>Customer</option>
                          </select>
                          @error('reason_for')
                          <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
