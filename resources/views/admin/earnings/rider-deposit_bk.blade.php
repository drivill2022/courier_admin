                ...
                <div class="page-content">
                    ...
                    <ul class="my-3 nav nav-pills nav-justified bg-light" role="tablist">
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'daily') active @endif" href="{{ route('admin.rider_deposit',['daily']) }}"
                                role="tab">
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'weekly') active @endif" href="{{ route('admin.rider_deposit',['weekly']) }}"
                                role="tab">
                                <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'monthly') active @endif" href="{{ route('admin.rider_deposit',['monthly']) }}" role="tab">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <form action="{{ route('admin.rider_deposit',[$active]) }}" method="POST">@csrf
        ...
        $(document).ready(function(){ 
           $(".status_change").on('change', function postinput(){
            if (confirm('Are you sure , you want to change status')) {
                   ...
                   var url = "<?php echo url('/').'/admin/changeRiderDepositStatus';?>"
                                $.ajax({ 
                                    url: url,
                                    type: 'POST',
                                    method: 'POST',
