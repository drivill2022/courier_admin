    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
          <h4 class="mb-0">Edit Vehicle Brand</h4>
            ...
            <div class="card">
              <div id="addproduct-billinginfo-collapse" class="collapse show" data-bs-parent="#addproduct-accordion">
                <div class="p-4 border-top">
                  <form method="POST" action="{{ route('admin.vehicle.brands.update', $brand->id) }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="mb-3">
                          ...
                          <select  class="form-select" name="status" id="statusm">
                            <option value="Active" @if ($brand->status=='Active')
                              ...
                              <option value="Blocked" @if ($brand->status=='Blocked')
                          ...
                          <div class="row my-4">
                            <div class="col text-end">
                              <a href="{{ route('admin.vehicle.brands.index') }}" class="btn btn-danger"> <i class="uil uil-times me-1"></i> Cancel </a>
