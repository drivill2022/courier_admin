...
<a href="{{ route('merchant.help.index') }}">
...
<form class="form-horizontal" action="{{route('merchant.help.update',$list->id)}}" method="POST" enctype="multipart/form-data" role="form">
    @csrf
    @method('PATCH')
     <div class="mb-3">
    ...
    <div class="row mb-4">
        <div class="col text-end">
            <a href="{{ route('merchant.help.index') }}" class="btn btn-danger"> <i class="uil uil-times me-1"></i> Cancel </a>
