                    ...
                    <div id="addproduct-accordion" class="custom-accordion">
                        <div class="card">
                            <div class="p-4 border-top">
                                <form method="POST" action="{{ route('merchant.shipment.import') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                           ...
                                           <div class="col-lg-6">
                                                ...
                                                <a href="{{asset('public/backend/shipment-import.xlsx')}}" download>Download Sample File</a>
                                            </div>  
