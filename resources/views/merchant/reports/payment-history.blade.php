                ...
                <div class="card-body">
                     ...
                     <ul class="my-3 nav nav-pills nav-justified bg-light" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link @if($type == 'daily') active @endif" href="{{ route('merchant.payment-history',['daily']) }}"
                                            role="tab">
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link @if($type == 'weekly') active @endif" href="{{ route('merchant.payment-history',['weekly']) }}"
                                            role="tab">
                                            <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link @if($type == 'monthly') active @endif" href="{{ route('merchant.payment-history',['monthly']) }}" role="tab">
                    ...
                    <div class="tab-pane active" id="navpills2-all" role="tabpanel">
                     ...
                     <div class="row">
                        <div class="col-12">
                    <form action="{{ route('merchant.payment-history',[$type]) }}" method="POST">@csrf
