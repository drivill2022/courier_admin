                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ url('merchant/login') }}" method='post'>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="mobile" name="mobile" placeholder="Enter mobile" {{old('mobile')}}>
                                    ...
                                    <div class="form-check">
                                        <div class="float-end">
                                            <a href="{{url('/merchant/password/reset')}}" class="text-muted">Forgot password?</a>
                                        </div>
