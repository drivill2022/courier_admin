...
$current = route('hub.hub_shipment_report',[$active]).'/';
@endphp
                ...
                <div class="page-content">
                    ...
                    <ul class="my-3 nav nav-pills nav-justified bg-light" role="tablist">
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'daily') active @endif" href="{{ route('hub.hub_shipment_report',['daily']) }}"
                                role="tab">
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'weekly') active @endif" href="{{ route('hub.hub_shipment_report',['weekly']) }}"
                                role="tab">
                                <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'monthly') active @endif" href="{{ route('hub.hub_shipment_report',['monthly']) }}" role="tab">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <form action="{{ route('hub.hub_shipment_report',[$active]) }}" method="POST">@csrf
