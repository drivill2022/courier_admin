...
$current = route('hub.hub_earning_statement',[$active]).'/';
 @endphp
                ...
                <div class="card-body">
                    ...
                    <ul class="my-3 nav nav-pills nav-justified bg-light" role="tablist">
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'daily') active @endif" href="{{ route('hub.hub_earning_statement',['daily']) }}"
                                role="tab">
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'weekly') active @endif" href="{{ route('hub.hub_earning_statement',['weekly']) }}"
                                role="tab">
                                <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link @if($active == 'monthly') active @endif" href="{{ route('hub.hub_earning_statement',['monthly']) }}" role="tab">
                    ...
                    <div class="tab-content p-3 text-muted">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <form action="{{ route('hub.hub_earning_statement',[$active]) }}" method="POST">@csrf
