                    ...
                    <div id="addproduct-accordion" class="custom-accordion">
                        <div class="card">
                            <div class="p-4 border-top">
                                <form method="POST" action="{{ route('hub.riders.update',$rider->id) }}" name="add-riders" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')
                                    <div class="row">
                                        <div class="col-lg-6"> 
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select  class="form-select" name="gender" id="statusm">
                                                                            ...
                                                                            <div id="div1" class="{{(2==$rider->vehicle_type_id)?:"hide"}}">
                                                                                <div class="row mt-3">
                                                                                    ...
                                                                                    <div class="col-lg-6"> <div class="mb-3"> <label class="form-label" for="brand">Brand:</label>
                                                                                        <x-vehicle-brands-dropdown :selected="$rider->vehicle?$rider->vehicle->brand:''"/>
                                                                                            @error('brand')
                                                                                            <span class="invalid-feedback" role="alert">
                                                                                                <strong>{{ $message }}</strong>
                                                                                            </span>
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        <div class="mb-3">
                                                                                            ...
                                                                                            <x-vehicle-models-dropdown :selected="$rider->vehicle?$rider->vehicle->model:''"/>
                                                                                                @error('model')
                                                                                                <span class="invalid-feedback" role="alert">
                                                                                                    <strong>{{ $message }}</strong>
                                                                                                </span>
                                                                                        ...
                                                                                        <div class="col-lg-6">
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                <x-vehicle-regions-dropdown :selected="$rider->vehicle?$rider->vehicle->region:''"/>
                                                                                                    @error('region')
                                                                                                    <span class="invalid-feedback" role="alert">
                                                                                                        <strong>{{ $message }}</strong>
                                                                                                    </span>
                                                                                            ...
                                                                                            <div class="col-lg-6">
                                                                                                <div class="mb-3">
                                                                                                    ...
                                                                                                    <x-vehicle-category-dropdown :selected="$rider->vehicle?$rider->vehicle->category:''"/> 
